...
arg.add_argument('--dataset', type=str, default='celeba')
...
arg.add_argument('--data_dir', type=str, default='D:\\alvin_data\\')
...
def GeneratorCNN(z, hidden_num, data_format, reuse):
    with tf.variable_scope("G", reuse=reuse) as vs:
        ...
        x11 = slim.conv2d(x10, hidden_num, 3, 1, activation_fn=tf.nn.elu, data_format=data_format)
